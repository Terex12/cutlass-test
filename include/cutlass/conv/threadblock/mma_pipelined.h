...
#include "cutlass/conv/threadblock/mma_base.h"
namespace cutlass {
namespace conv {
...
public:
    ...
    using Shape = Shape_;             ///< Size of the Gemm problem - concept: conv::GemmShape<>
    using IteratorA = IteratorA_;     ///< Iterates over tiles of A operand in global memory
    using IteratorB = IteratorB_;     ///< Iterates over tiles of B operand in global memory
    using ElementC = ElementC_;       ///< Data type of accumulator matrix
    using LayoutC = LayoutC_;         ///< Layout of accumulator matrix
    using Policy = Policy_;           ///< Policy describing tuning details
    /// actual policy in conv exmaple is typename MmaCore::MmaPolicy form defualt_mma.h
...
public:
    ...
    CUTLASS_DEVICE
    void operator()(
            int conv_k_iterations,                            ///< number of iterations of the mainloop
